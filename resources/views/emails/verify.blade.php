...
<div class="email-wrapper-container" style="width: 50%; margin: 40px auto; padding: 20px 50px; background: #f5f5f5;">
    ...
    <div class="main-content-wrap" style="background: #fff; padding: 30px 40px; margin-bottom: 30px;">
        ...
        <h2 style="font-size: 1.6rem; font-weight: 400; color:#333;">Hi {{$email}},</h2>
        ...
        <p style="color: #777; line-height: 1.9; margin-bottom: 20px;">If you didn't attempt to verify your email address with {{ config('app.name', 'Laravel') }}, Please delete this email.</p>
