                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">Edit Testimonial </h4>
                            </div>
...
<!-- 
                                        ...
                                        <img src="{{ asset('public/uploads/testimonial/'.$testimonial->image) }}" class="avatar avatar-xxl brround" alt="" id="one" >
                                    </div>
                                                </div>
                                            </div>
