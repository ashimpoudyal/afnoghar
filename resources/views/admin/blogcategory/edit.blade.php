...
@section('title') Edit Blog Category - {{ config('app.name', 'Laravel') }}   @endsection
                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">Edit Blog Category</h4>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-12 col-lg-12">
                              ...
                              @include('admin.includes.message')
                                ...
                                <form action="{{ route('blogupdateCategory', $myCategory->id) }}" method="post" enctype="multipart/form-data">
                                    @csrf
                                <div class="card">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" id="order" name="order" class="form-control" placeholder="Priority Order" value="{{$myCategory->order}}">
                                                </div>
                                            </div>
