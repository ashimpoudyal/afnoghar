...
@section('title') Menus - {{ config('app.name', 'Laravel') }}   @endsection
                    ...
                    <div class="side-app">
                        ...
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">All Menus</h4>
                            </div>
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{route('menu.add')}}"><button class="btn btn-outline-primary"><i class="fe fe-download"></i>
                                       Add Menu </button></a>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-bordered text-nowrap" id="example1">
                                                  ...
                                                  @foreach($menus as $menu)
                                                    ...
                                                    <tr>
                                                        <td>{{ $loop->index + 1 }}</td>
                                                         ...
                                                         <td>
                                                              @if(!empty($menu->image))
                                                   <img src="{{ asset('public/uploads/menu/'.$menu->image) }}" width="100px">
                                               @else
                                               ...
                                               @endif
                                                          ...
                                                          <td>{{$menu->name}}</td>
                                                          <td>{{ isset($menu->category) ? $menu->category->category_name : '-'}}</td>
                                                          <td>{{$menu->type}}</td>

                                                          <td>{{$menu->sellingprice}}</td>
                                           ...
                                           <button class="btn btn-success btn-sm">
                                             ...
                                             <a class="btn btn-danger btn-sm deleteRecord" style="color: white" href="javascript:" rel="{{ $menu->id }}" rel1="delete-menu">
