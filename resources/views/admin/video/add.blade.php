...
@section('title') Add New Video  - {{ config('app.name', 'Laravel') }}   @endsection
...
@section('content')
                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">Add Video </h4>
                            </div>
 ...
 -->
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                                <input type="radio" class="btn-check" name="featured" id="btnradio1" autocomplete="off"  value="1">
                                                <label class="btn btn-outline-primary" for="btnradio1">Yes</label>

                                                <input type="radio" class="btn-check" name="featured" id="btnradio2" autocomplete="off" checked="" value="0">
