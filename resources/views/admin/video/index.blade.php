...
@section('title') Video - {{ config('app.name', 'Laravel') }}   @endsection
                    ...
                    <div class="side-app">
                        ...
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">All video</h4>
                            </div>
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{ route('video.add') }}"><button class="btn btn-outline-primary"><i class="fe fe-download"></i>
                                       Add video </button></a>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">Video Table</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                   @foreach($videos as $video)
                                                    ...
                                                    <tr>
                                                      <td>{{ $loop->index + 1 }}</td>
                                                       <td>
                                                <img src="{{ asset('public/uploads/video/'.$video->image) }}" alt="" width="100">
                                            </td>
                                                        <td>{{$video->name}}</td>

                                                         <td>
                                                           @if($video->featured == 1)
                                                           <span class="badge bg-success" style="color: white;">Yes</span>
                                                       @else
                                           ...
                                           <button class="btn btn-success btn-sm">
                                               ...
                                               <a class="btn btn-danger btn-sm deleteRecord" style="color: white" href="javascript:" rel="{{ $video->id }}" rel1="delete-video">
