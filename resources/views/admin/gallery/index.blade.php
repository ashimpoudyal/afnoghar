                    ...
                    <div class="side-app">
                        ...
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">All Gallery</h4>
                            </div>
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{ route('gallery.add') }}"><button class="btn btn-outline-primary"><i class="fe fe-download"></i>
                                       Add Gallery </button></a>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">Gallery Table</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                                ...
                                                <tbody>
                                                   @foreach($gallerys as $gallery)
                                                    ...
                                                    <tr>
                                                      <td>{{ $loop->index + 1 }}</td>
                                                       <td>
                                                <img src="{{ asset('public/uploads/gallery/'.$gallery->image) }}" alt="" width="100">
                                            </td>
                                                        <td>{{$gallery->title}}</td>
                                           ...
                                           <button class="btn btn-warning btn-sm" >
                                               <i class="fa fa-eye"></i>
                                                        ...
                                                        <a href="{{ route('editGallery', $gallery->id) }}">
                                           <button class="btn btn-success btn-sm">
                                               ...
                                               <a class="btn btn-danger btn-sm deleteRecord" style="color: white" href="javascript:" rel="{{ $gallery->id }}" rel1="delete-gallery">
