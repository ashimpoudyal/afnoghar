...
@section('title') Partner - {{ config('app.name', 'Laravel') }}   @endsection
                    ...
                    <div class="side-app">
                        ...
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">All Partners</h4>
                            </div>
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{route('partner.add')}}"><button class="btn btn-outline-primary"><i class="fe fe-download"></i>
                                       Add Partner </button></a>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered text-nowrap" id="example1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-10p border-bottom-0">Partner Name</th>
                                                ...
                                                <tbody>
                                                  @foreach($partners as $partner)
                                                   ...
                                                   <img src="{{ asset('public/uploads/partner/'.$partner->image) }}" width="100px">
                                               @else
                                               ...
                                               @endif
                                                        ...
                                                        <a href="{{ route('editPartner', $partner->id) }}">
                                           <button class="btn btn-success btn-sm">
                                             ...
                                             <a class="btn btn-danger btn-sm deleteRecord" style="color: white" href="javascript:" rel="{{ $partner->id }}" rel1="delete-partner">
