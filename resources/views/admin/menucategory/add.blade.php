...
@section('title') Add Menu Category - {{ config('app.name', 'Laravel') }}   @endsection
                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">Add Menu Category</h4>
                            </div>
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{route('menucategory.index')}}"><button class="btn btn-outline-primary"><i class="fe fe-eye"></i>
                                       View Menu Category </button></a>
                              ...
                              @include('admin.includes.message')
                                ...
                                <div class="card">
                                    <div class="card-header ">
                                        <div class="card-title">Menu Category Details</div>
                                    </div>
                                    <div class="card-body">
