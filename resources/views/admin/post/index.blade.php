...
@section('title') Posts - {{ config('app.name', 'Laravel') }}   @endsection
                    ...
                    <div class="side-app">
                        ...
                        <div class="page-header">
                            ...
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{route('post.add')}}"><button class="btn btn-outline-primary"><i class="fe fe-download"></i>
                                       Add Post </button></a>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered text-nowrap" id="example1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-10p border-bottom-0">Post Name</th>
                                                        <th class="wd-25p border-bottom-0">Post Slug</th>
                                           ...
                                           <button class="btn btn-success btn-sm">
                                             ...
                                             <a class="btn btn-danger btn-sm deleteRecord" style="color: white" href="javascript:" rel="{{ $post->id }}" rel1="delete-post">
