...
@section('title') Edit Admin - {{ config('app.name', 'Laravel') }}   @endsection
                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">Edit Admin</h4>
                            </div>
                       ...
                       <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <form class="row g-3 needs-validation" action="{{ route('admin.update' , $admin->id) }}" method="post" enctype="multipart/form-data">
                                           @csrf
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><div class="col-auto">
                                                            <label class="colorinput">
                                                                <input  type="checkbox"  class="colorinput-input" name="post_c" @if($admin->post_c == 1) checked @endif>
                                                        ...
                                                        <td><div class="col-auto">
                                                            <label class="colorinput">
                                                                <input  type="checkbox"  class="colorinput-input"  name="post_r" @if($admin->post_r == 1) checked @endif>
                                                                <span class="colorinput-color bg-azure"></span>
                                                            </label>
                                                        </div></td>
                                                        ...
                                                        <td><div class="col-auto">
                                                            <label class="colorinput">
                                                                <input type="checkbox"  class="colorinput-input"   name="post_u" @if($admin->post_u == 1) checked @endif>
                                                                <span class="colorinput-color bg-azure"></span>
                                                            </label>
                                                        </div></td>
                                                        ...
                                                        <td><div class="col-auto">
                                                            <label class="colorinput">
                                                                <input  type="checkbox"  class="colorinput-input"   name="post_d" @if($admin->post_d == 1) checked @endif>
                                                                <span class="colorinput-color bg-azure"></span>
                                                            </label>
                                                        </div></td>
