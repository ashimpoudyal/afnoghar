...
@section('title') Add Room Category - {{ config('app.name', 'Laravel') }}   @endsection
                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">Add Room Category</h4>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                             ...
                                             <div class="col-md-6">
                                              ...
                                              <input type="text" id="cp" name="cp" class="form-control" placeholder="Category Name" value="{{ old('cp') }}">
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-md-6">
                                              ...
                                              <input type="text" id="sp" name="sp" class="form-control" placeholder="Category Name" value="{{ old('sp') }}">
                                                </div>
                                            </div>
                                              ...
                                              <input type="text" id="no_of_room" name="no_of_room" class="form-control" placeholder="Category Name" value="{{ old('no_of_room') }}">
                                                </div>
                                            </div>
                                       ...
                                       <!--   <div class="form-group mb-0">
                                            <input id="demo" type="file" name="image[]" id="image"  accept=".jpg, .png, image/jpeg, image/png" multiple="multiple" class="ff_fileupload_hidden">
                                        </div> -->
