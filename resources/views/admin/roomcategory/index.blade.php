...
@section('title') Room Categories - {{ config('app.name', 'Laravel') }}   @endsection
                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">All Room Categories</h4>
                            </div>
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{route('roomcategory.add')}}"><button class="btn btn-outline-primary"><i class="fe fe-download"></i>
                                       Add Room Category </button></a>
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">Room Category Table</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="table-responsive">
                                                      ...
                                                      <!--   <td>
                                                       ...
                                                       @endif
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{route('roomGallery' , $category->id)}}">
                                           ...
                                           <a href="{{ route('roomcategory.edit', $category->id) }}">
                                           <button class="btn btn-success btn-sm">
                                               ...
                                               <a class="btn btn-danger btn-sm deleteRecord" style="color: white" href="javascript:" rel="{{ $category->id }}" rel1="delete-roomcategory">
