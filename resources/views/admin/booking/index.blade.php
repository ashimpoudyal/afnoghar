...
@section('title') Bookings - {{ config('app.name', 'Laravel') }}   @endsection
                    ...
                    <div class="side-app">
                        ...
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">All Bookings</h4>
                            </div>
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{route('booking.add')}}"><button class="btn btn-outline-primary"><i class="fe fe-download"></i>
                                       Add Booking </button></a>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table class="table table-bordered text-nowrap" id="example1">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="wd-15p border-bottom-0">Booked By</th>
                                                        <th class="wd-10p border-bottom-0">ROom Name</th>
                                                        <th class="wd-10p border-bottom-0">Category</th>
                                                        <th class="wd-10p border-bottom-0">Adults</th>
                                                        <th class="wd-10p border-bottom-0">Childrens</th>
                                                        <th class="wd-10p border-bottom-0">Check-in</th>
                                                        <th class="wd-10p border-bottom-0">Check-out</th>
                                                ...
                                                <tbody>
                                                 ...
                                                 @if(!empty($booking->image))
                                                   <img src="{{ asset('public/uploads/room/'.$booking->image) }}" width="100px">
                                               @else
                                               ...
                                               @endif
                                                        ...
                                                        <td>{{$booking->room->post_title}}</td>
                                                        <td>{{ isset($booking->category) ? $booking->category->category_name : '-'}}</td>
                                           ...
                                           <button class="btn btn-success btn-sm">
                                             ...
                                             <a class="btn btn-danger btn-sm deleteRecord" style="color: white" href="javascript:" rel="{{ $booking->id }}" rel1="delete-booking">
