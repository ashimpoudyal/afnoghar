...
@section('title') Add Event Category - {{ config('app.name', 'Laravel') }}   @endsection
                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">Add Event Category</h4>
                            </div>
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{route('eventcategory.index')}}"><button class="btn btn-outline-primary"><i class="fe fe-eye"></i>
                                       View  Event Category </button></a>
                              ...
                              @include('admin.includes.message')
                                ...
                                <div class="card">
                                    <div class="card-header ">
                                        <div class="card-title">Event Category Details</div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-6 col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="category_name" name="category_name" class="form-control"  value="{{$myCategory->category_name}}">
                                                </div>
                                            </div>
