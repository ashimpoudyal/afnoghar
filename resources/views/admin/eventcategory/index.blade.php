...
@section('title') Event Categories - {{ config('app.name', 'Laravel') }}   @endsection
                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">All Event Categories</h4>
                            </div>
                            <div class="page-rightheader">
                                <div class="btn-list">
                                    <a href="{{route('eventcategory.add')}}"><button class="btn btn-outline-primary"><i class="fe fe-download"></i>
                                       Add Event Category </button></a>
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                           ...
                                           <button class="btn btn-success btn-sm">
                                               ...
                                               <a class="btn btn-danger btn-sm deleteRecord" style="color: white" href="javascript:" rel="{{ $category->id }}" rel1="delete-eventcategory">
