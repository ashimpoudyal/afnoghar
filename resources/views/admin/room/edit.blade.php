...
@section('title') Edit Room - {{ config('app.name', 'Laravel') }}   @endsection
                       ...
                       <!--Page header-->
                        <div class="page-header">
                            <div class="page-leftheader">
                                <h4 class="page-title mb-0 text-primary">Edit Room</h4>
                            </div>
                              ...
                              @include('admin.includes.message')
                               ...
                               <form action="{{ route('room.update', $room->id) }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                               ...
                                               <input type="text" class="form-control" id="post_title" name="post_title" value="{{ $room->post_title }}">
                                              </div>
                                            </div>
                                    ...
                                    <div class="form-group" style="margin-top: 10px">
                                         ...
                                         <img src="{{ asset('public/uploads/room/'.$room->image) }}" alt="" id="one" class="avatar avatar-xxl brround" alt="" id="one" >
                                         @else
                                         ...
                                         @endif
                                            ...
                                            <div class="btn-group" role="group" aria-label="Basic radio toggle button group">
                                                <input type="radio" class="btn-check" name="status" id="btnradio1" autocomplete="off" checked="" value="1" @if($room->status == 1) checked @endif>
                                                <label class="btn btn-outline-primary" for="btnradio1">Active</label>

                                                <input type="radio" class="btn-check" name="status" id="btnradio2" autocomplete="off" value="0"  @if($room->status == 0) checked @endif>
                                            ...
                                            <div class="col-md-12">
                                               ...
                                               <textarea name="post_content" id="post_content" cols="30" rows="10" class="form-control">{{ $room->post_content }}</textarea>
                                                </div>
                                            </div>
                                             ...
                                             <div class="col-sm-6 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="ammeties" id="ammeties" cols="30" rows="10" class="form-control">{{ $room->ammeties }}</textarea>
                                                </div>
                                                </div>
                                               ...
                                               <input type="text" class="form-control" id="cp" name="cp" value="{{ $room->cp }}">
                                              </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                               ...
                                               <input type="text" class="form-control" id="sp" name="sp" value="{{ $room->sp }}">
                                              </div>
                                            </div>
                                             ...
                                             <div class="col-sm-6 col-md-6">
                                               ...
                                               <input type="text" class="form-control" id="rating" name="rating" value="{{ $room->rating }}">
                                              </div>
                                            </div>
