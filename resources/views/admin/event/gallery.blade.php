...
@section('title') Add Gallery  - {{ config('app.name', 'Laravel') }}   @endsection
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-lg-4">
                                <div class="card box-widget widget-user">
                                    <div class=""><img alt="User Avatar" src="{{ asset('public/uploads/event/'.$events->image) }}"></div>
                                    <div class="card-body text-center pt-2">
                                        <div class="pro-user">
                                            <h3 class="pro-user-username  mb-1 fs-22">{{$events->name}}</h3>

                                             <a href="{{ route('editEvent', $events->id) }}" class="btn btn-success mt-3"><i class="fa fa-pencil"></i>Edit</a>
                                ...
                                <div class="card">
                                   ...
                                   <div class="field_wrapper">
                                        <div>
                                            ...
                                            <form action="{{ route('eventGallery', $events->id) }}" method="post" enctype="multipart/form-data">
                                              @csrf
                                                   ...
                                                   @foreach($gallery as $image)
                                                    ...
                                                    <tr>
                                                        <td>{{ $loop->index + 1 }}</td>
                                                            ...
                                                            <td>
                                                  <img src="{{ asset('public/uploads/event/gallery/'.$image->image) }}" alt="" width="100">
                                              </td>
