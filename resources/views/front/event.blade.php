					...
					<div class="col-md-12">
						<div class="head-typo typo-com">
							...
							<div class="row events">
								<div class="col-md-2"> <img style="width: 151.33;height: 94.58;" src="{{asset('public/uploads/event/'.$event->image)}}" alt="" /> </div>
								<div class="col-md-8">
									<h3>{{$event->name}}</h3> <span>Date: {{$event->date}}</span>
									<p>{!!$event->description!!}</p>
								</div>
								<div class="col-md-2"> <a href="{{route('eventDetail',['slug'=>$event->slug])}}" class="waves-effect waves-light event-regi">Read More</a> </div>
							</div>
							<!--END EVENT-->
							@endforeach
						</div>
