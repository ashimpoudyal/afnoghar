...
<!--TOP SECTION-->
<div class="hp-banner"> <img style="width: 1349px; height: 380.72px;" src="{{asset('public/uploads/room/'.$room->image)}}" alt=""> </div>
<!--END HOTEL ROOMS-->
				...
				<div class="row">
						...
						<div class="row">
							...
							<div class="hp-section">
								...
								<div class="">
									<div class="h-gal">
										<ul>
											@foreach($roomgalleries as $roomgalleries)
                                                
                                          
											<li><img class="materialboxed" style="width: 251.66px; height: 175.34px;" data-caption="Hotel Captions" src="{{asset('public/uploads/roomcategory/gallery/'.$roomgalleries->image)}}" alt="">
											</li>
                                            @endforeach
										</ul>
									</div>
					...
					<div class="col-md-4">
						...
						<div class="hp-call hp-right-com">
							...
							<div class="hp-call-in"> <img src="{{asset('public/assets/front/assets/img/dbc4.png')}}" alt="">
								<h3><span>Check Availability. Call us!</span> +01 4214 4214</h3> <small>We are available 24/7 Monday to Sunday</small> <a href="{{route('front.booking.add',$room->id)}}">Book Now</a> </div>
						</div>
						<!--=========================================-->
						<!--=========================================-->
